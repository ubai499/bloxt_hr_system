document.addEventListener('DOMContentLoaded', () => {
    'use strict';
    const config = window.contractPage;
    ...
    function reset() {
        ...
        form.elements.category.value = fields.category.value === 'all' ? 'Employment Contract' : fields.category.value;
    ...
    form.addEventListener('submit', async event => {
        ...
        try {
            ...
            fields.status.value = 'all'; fields.search.value = ''; fields.employee.value = 'all';
            reset();
            try {
