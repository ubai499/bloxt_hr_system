...
use App\Http\Controllers\Admin\ImmigrationController;
...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/immigration', [ImmigrationController::class, 'index'])->name('immigration.index');
    Route::get('/immigration/create', [ImmigrationController::class, 'create'])->name('immigration.create');
    Route::get('/immigration/export', [ImmigrationController::class, 'export'])->name('immigration.export');
    Route::post('/immigration', [ImmigrationController::class, 'store'])->name('immigration.store');
    Route::get('/immigration/{check}', [ImmigrationController::class, 'show'])->name('immigration.show');
    Route::put('/immigration/{check}', [ImmigrationController::class, 'update'])->name('immigration.update');
    Route::delete('/immigration/{check}', [ImmigrationController::class, 'destroy'])->name('immigration.destroy');
    ...
    Route::put('/sponsorship/licence', [SponsorshipController::class, 'updateLicence'])->name('sponsorship.licence.update');
    Route::post('/sponsorship/workers', [SponsorshipController::class, 'storeWorker'])->name('sponsorship.workers.store');
    Route::get('/sponsorship/workers/{record}', [SponsorshipController::class, 'showWorker'])->name('sponsorship.workers.show');
    Route::put('/sponsorship/workers/{record}', [SponsorshipController::class, 'updateWorker'])->name('sponsorship.workers.update');
    Route::delete('/sponsorship/workers/{record}', [SponsorshipController::class, 'destroyWorker'])->name('sponsorship.workers.destroy');
    Route::post('/sponsorship/events', [SponsorshipController::class, 'storeEvent'])->name('sponsorship.events.store');
    Route::get('/sponsorship/events/{event}', [SponsorshipController::class, 'showEvent'])->name('sponsorship.events.show');
    Route::put('/sponsorship/events/{event}', [SponsorshipController::class, 'updateEvent'])->name('sponsorship.events.update');
    Route::delete('/sponsorship/events/{event}', [SponsorshipController::class, 'destroyEvent'])->name('sponsorship.events.destroy');
    Route::post('/sponsorship/changes', [SponsorshipController::class, 'storeChange'])->name('sponsorship.changes.store');
    Route::get('/sponsorship/changes/{change}', [SponsorshipController::class, 'showChange'])->name('sponsorship.changes.show');
    Route::put('/sponsorship/changes/{change}', [SponsorshipController::class, 'updateChange'])->name('sponsorship.changes.update');
    Route::delete('/sponsorship/changes/{change}', [SponsorshipController::class, 'destroyChange'])->name('sponsorship.changes.destroy');
    Route::post('/sponsorship/guidance', [SponsorshipController::class, 'storeGuidance'])->name('sponsorship.guidance.store');
    Route::get('/sponsorship/guidance/{guidance}', [SponsorshipController::class, 'showGuidance'])->name('sponsorship.guidance.show');
    Route::put('/sponsorship/guidance/{guidance}', [SponsorshipController::class, 'updateGuidance'])->name('sponsorship.guidance.update');
    Route::delete('/sponsorship/guidance/{guidance}', [SponsorshipController::class, 'destroyGuidance'])->name('sponsorship.guidance.destroy');
    ...
    Route::get('/compliance/reviews/{review}', [ComplianceController::class, 'show'])->name('compliance.reviews.show');
    Route::put('/compliance/reviews/{review}', [ComplianceController::class, 'update'])->name('compliance.reviews.update');
    Route::delete('/compliance/reviews/{review}', [ComplianceController::class, 'destroy'])->name('compliance.reviews.destroy');
    Route::get('/reports', [ReportController::class, 'index'])->name('reports.index');
    Route::get('/reports/create', [ReportController::class, 'create'])->name('reports.create');
    Route::get('/reports/{report}/export', [ReportController::class, 'export'])->name('reports.export');
    Route::get('/reports/{report}', [ReportController::class, 'show'])->name('reports.show');
    Route::post('/reports/tasks', [ReportController::class, 'storeTask'])->name('reports.tasks.store');
    Route::put('/reports/tasks/{task}', [ReportController::class, 'updateTask'])->name('reports.tasks.update');
    Route::patch('/reports/tasks/{task}/status', [ReportController::class, 'updateTaskStatus'])->name('reports.tasks.status');
    Route::patch('/reports/notifications/{notification}', [ReportController::class, 'resolveNotification'])->name('reports.notifications.resolve');
