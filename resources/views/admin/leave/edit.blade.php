...
@section('content')
    <div class="page-header-bar"><div class="breadcrumb-trail"><a href="{{ route('admin.leave.index') }}">Leave</a><span class="breadcrumb-sep">/</span>Edit Request</div><h1 class="page-title">Edit Leave Request</h1><p class="page-subtitle">Update a pending leave request before a decision.</p></div>
